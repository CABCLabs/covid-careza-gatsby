...
export const RonaldTemplate = ({
  ...
  return (
    ...
    <div className="container">
      ...
      <h3 class="ronaldIntro"><strong>Hi, I&rsquo;m Ronald, and I&rsquo;m here to con you </strong></h3>
      </div>
      </div>
      <div className="columns">
...
<p>Soon, Pete invited me into his home, and now I am a part of his life.</p>
<p>My work is done.</p>
<p>In recognition of my work, the Centre for Analytics and Behavioural Change has produced a short film on me. The film will be screened by DSTV soon, watch out for it. Remember, my name is Ronald.</p>
<p>And if you would like to make me even more famous by broadcasting the film, please contact the CABC.</p>
<p>Meanwhile, my friends and I will be hiding in plain view on social media. If you really want to find us, look for accounts with unusual names and numbers. Usually, we don&rsquo;t have profile pictures and we use stock images. We have a low number of followers, but a very high number of tweets pushing out our narrative only. If you come across these features, you have found us.</p>
<p>But why go to all that trouble? Just watch the short film about me</p>
         </div>
          </div>
      <div className="columns">
        <div className="column is-12">
    ...
    <div class="learnMoreBox">
      ...
      <div className="column is-6 infoBox">
         ...
         <p>Fake accounts are mostly used to amplify the popularity or dislike of a person or movement, thus manipulating users' views of true public sentiment. <a href="https://phys.org/news/2019-05-fake-facebook-accounts-never-ending-bots.html" target="_blank"><br/>Read more here >></a></p>
          </div>
          <div className="column is-6 infoBox">
          <h3>Are you a bot?</h3>
          <p>Asked the bot to verify if they have gotten through to another bot or a believer. How do you know who you are engaging with online? Can you tell who is a bot or who isn’t? <a href="https://www.nytimes.com/2020/06/16/science/social-media-bots-kazemi.html" target="_blank"><br/>Read more here >></a></p>
          </div>
          </div>
         ...
         <p>Bot Sentinel was created to fight disinformation and targeted harassment through tracking all Twitter accounts using a machine learning and artificial intelligence model. The aim is to allow Twitter users to engage in online conversations without the interference of bots that manipulate and change the conversation. The bot accounts are then added to a public database that the public can browse and use to make informed decisions. <a href="https://botsentinel.com/" target="_blank"><br/>See more here >></a></p>
          </div>
          <div className="column is-6 infoBox">
          <h3>Learn to Discern (L2D) - Media Literacy Training </h3>
          <p>Learn to Discern is a program that aims to share their approach with individuals in order to help them create healthy habits for engaging with online information. The idea is to build resilience to mis and disinformation at a community level. This is done by empowering individuals and helping them to recognize and reject divisive narratives, hate speech and misinformation ultimately making them less susceptible to consuming propaganda and mis and disinformation. <a href="https://www.irex.org/project/learn-discern-l2d-media-literacy-training" target="_blank"><br/>Learn more >></a></p>
          </div>
    </div>
    </div>
    </div>
